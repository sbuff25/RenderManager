...
# Check if native mode is available (pywebview + PyQt6)
...
if __name__ in {"__main__", "__mp_main__"}:
    ...
    if HAS_NATIVE_MODE:
        ...
        print("pywebview/PyQt6 not available - running in browser mode")
        print("Tip: Install Python 3.10-3.12 for native desktop window support")
