            ...
            with ui.row().classes('w-full items-center justify-between mb-2'):
                ...
                with ui.row().classes('gap-2'):
                    def save_log_to_file():
                        ...
                        log_path = os.path.join(os.getcwd(), 'wane_render_log.txt')
                        try:
                    ...
                    ui.button('Save Log to File', icon='save', on_click=save_log_to_file).props('flat dense').classes('text-zinc-300 hover:text-white bg-zinc-800 hover:bg-zinc-700').tooltip('Save to wane_render_log.txt')
